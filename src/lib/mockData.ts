...
export const reviews: Review[] = [
  { id: 1, author: 'Alice Johnson', avatar: 'https://i.pravatar.cc/150?img=4', rating: 5, comment: 'This course was fantastic! I learned so much.' },
  { id: 2, author: 'Bob Williams', avatar: 'https://i.pravatar.cc/150?img=5', rating: 4, comment: 'Great content and well-explained concepts.' },
  { id: 3, author: 'Charlie Brown', avatar: 'https://i.pravatar.cc/150?img=6', rating: 5, comment: 'Highly recommended for beginners.' },
];
